...
export default function TmaBootstrapPage() {
  const router = useRouter();
  const sp = useSearchParams();
  const [msg, setMsg] = useState<string>("Telegram’dan initData olinmoqda...");
  ...
  return (
    <main className="p-4 space-y-2">
      ...
      <div className="text-xs text-gray-500">
        Agar Telegram ichida ochgan bo‘lsangiz-u baribir ishlamasa: bot ichidan “Open App” tugmasi bilan oching.
      </div>
    </main>
  );
}
